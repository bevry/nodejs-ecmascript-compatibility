...
<h1>Node.js ECMAScript Compatibility</h1>
...
<span class="badge-daviddm"><a href="https://david-dm.org/bevry/nodejs-ecmascript-compatibility" title="View the status of this project's dependencies on DavidDM"><img src="https://img.shields.io/david/bevry/nodejs-ecmascript-compatibility.svg" alt="Dependency Status" /></a></span>
<span class="badge-daviddmdev"><a href="https://david-dm.org/bevry/nodejs-ecmascript-compatibility#info=devDependencies" title="View the status of this project's development dependencies on DavidDM"><img src="https://img.shields.io/david/dev/bevry/nodejs-ecmascript-compatibility.svg" alt="Dev Dependency Status" /></a></span>
...
<ul>
<li>Install: <code>npm install --save @bevry/nodejs-ecmascript-compatibility</code></li>
<li>Import: <code>import * as pkg from ('@bevry/nodejs-ecmascript-compatibility')</code></li>
<li>Require: <code>const pkg = require('@bevry/nodejs-ecmascript-compatibility')</code></li>
</ul>
...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/@bevry/nodejs-ecmascript-compatibility@^4.1.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/@bevry/nodejs-ecmascript-compatibility@^4.1.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/@bevry/nodejs-ecmascript-compatibility@4.1.0'
</script>
```
...
<a href="https://github.com/bevry/nodejs-ecmascript-compatibility/blob/master/HISTORY.md#files">Discover the release history by heading on over to the <code>HISTORY.md</code> file.</a>
...
<a href="https://github.com/bevry/nodejs-ecmascript-compatibility/blob/master/CONTRIBUTING.md#files">Discover how you can contribute by heading on over to the <code>CONTRIBUTING.md</code> file.</a>
...
<ul><li><a href="https://balupton.com">Benjamin Lupton</a> — <a href="https://github.com/bevry/nodejs-ecmascript-compatibility/commits?author=balupton" title="View the GitHub contributions of Benjamin Lupton on repository bevry/nodejs-ecmascript-compatibility">view contributions</a></li></ul>
