...
``` html
<script type="module">
    import * as pkg from '//cdn.skypack.dev/@bevry/nodejs-ecmascript-compatibility@^4.2.1'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/@bevry/nodejs-ecmascript-compatibility@^4.2.1'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/@bevry/nodejs-ecmascript-compatibility@4.2.1'
</script>
```
